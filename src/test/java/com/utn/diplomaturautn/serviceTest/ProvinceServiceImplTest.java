package com.utn.diplomaturautn.serviceTest;
...
public class ProvinceServiceImplTest {
    ...
    public void getByIdTest() {
        ...
        given(this.provinceRepository.findById(1)).willReturn(Optional.of(province));

        when(this.provinceServiceImpl.getById(1)).thenReturn(province);
